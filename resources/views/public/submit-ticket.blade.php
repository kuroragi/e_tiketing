            ...
            <div class="col-lg-8">
                <div class="form-card">
                    <div class="card-header">
                        <h4 class="mb-1"><i class="bi bi-pencil-square me-2"></i>Formulir Pengaduan Publik</h4>
                        <p class="mb-0 small opacity-75">Silakan lengkapi formulir di bawah ini. Semua data akan dijaga kerahasiaannya.</p>
                    </div>
                    <div class="card-body">
                        @if($errors->any())
                        ...
                        <form method="POST" action="{{ route('public.ticket.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="public_name" class="form-control @error('public_name') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="public_nik" class="form-control @error('public_nik') is-invalid @enderror"
                                        value="{{ old('public_nik') }}" placeholder="16 digit NIK" maxlength="16">
                                    @error('public_nik')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="public_email" class="form-control @error('public_email') is-invalid @enderror"
                                        value="{{ old('public_email') }}" required placeholder="email@contoh.com">
                                    @error('public_email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">No. HP / WhatsApp <span class="text-danger">*</span></label>
                                    <input type="text" name="public_phone" class="form-control @error('public_phone') is-invalid @enderror"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="public_address" class="form-control @error('public_address') is-invalid @enderror"
                                    rows="2" placeholder="Alamat lengkap Anda">{{ old('public_address') }}</textarea>
                                @error('public_address')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                    ...
                                    placeholder="Contoh: Permintaan Data CCTV Terkait Kejadian di Jl. Ahmad Yani">
                            ...
                            <div class="mb-4">
                                <label class="form-label">Lampiran <small class="text-muted">(opsional, maks 5 file)</small></label>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <span class="badge bg-dark px-3 py-2 fs-6" style="letter-spacing:3px;font-family:monospace;">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm mb-4" style="border-radius:1rem;">
                    <div class="card-body p-4 info-sidebar">
                        <h5 class="fw-bold mb-3"><i class="bi bi-info-circle text-primary me-2"></i>Informasi Penting</h5>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Data pribadi Anda akan dijaga kerahasiaannya sesuai ketentuan yang berlaku.</small>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Anda akan mendapatkan kode tracking setelah pengaduan terkirim untuk memantau status.</small>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Siapkan foto/dokumen pendukung untuk mempercepat proses verifikasi.</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm" style="border-radius:1rem;">
                    <div class="card-body p-4">
                        ...
                        <p class="text-muted small mb-3">Hubungi kami jika butuh bantuan dalam mengisi formulir pengaduan.</p>
