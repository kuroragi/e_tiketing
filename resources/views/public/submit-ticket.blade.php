                            ...
                            <form method="POST" action="{{ route('public.ticket.store') }}" enctype="multipart/form-data">
                                ...
                                @if (($layanan ?? '') === 'cctv')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Daerah / Area Kejadian <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">
                                            Titik Lokasi CCTV
                                            <small class="text-muted fw-normal">(opsional — landmark atau titik
                                                terdekat)</small>
                                        </label>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label class="form-label">Perkiraan Waktu Awal <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Keperluan Permintaan <span
                                                class="text-danger">*</span></label>
                                        <select name="keperluan"
                                            class="form-select @error('keperluan') is-invalid @enderror" required>
                                            <option value="">-- Pilih Keperluan --</option>
                                            <option value="Laporan Kepolisian"
                                                {{ old('keperluan') === 'Laporan Kepolisian' ? 'selected' : '' }}>Laporan
                                                Kepolisian</option>
                                            <option value="Penyelidikan / Investigasi"
                                                {{ old('keperluan') === 'Penyelidikan / Investigasi' ? 'selected' : '' }}>
                                                Penyelidikan / Investigasi</option>
                                            <option value="Keperluan Asuransi"
                                                {{ old('keperluan') === 'Keperluan Asuransi' ? 'selected' : '' }}>Keperluan
                                                Asuransi</option>
                                            <option value="Kepentingan Instansi Pemerintah"
                                                {{ old('keperluan') === 'Kepentingan Instansi Pemerintah' ? 'selected' : '' }}>
                                                Kepentingan Instansi Pemerintah</option>
                                            <option value="Keperluan Lainnya"
                                                {{ old('keperluan') === 'Keperluan Lainnya' ? 'selected' : '' }}>Keperluan
                                                Lainnya</option>
                                        </select>
                                        @error('keperluan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Keterangan Tambahan <small
                                ...
                                @else
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Kategori Layanan <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Judul Pengaduan <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <div class="form-text">Minimal 20 karakter. Semakin detail, semakin cepat kami
                                            dapat
                                            memproses.</div>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div id="pub-drop-zone" class="rounded-3 p-4 text-center"
            ...
            function renderFileList() {
                ...
                files.forEach(function(file, i) {
                    ...
                    row.innerHTML =
                        ...
                        '<span class="text-muted text-nowrap">' + (file.size / 1024 / 1024).toFixed(1) +
                        ' MB</span>' +
                        '<button type="button" class="btn btn-sm btn-outline-danger py-0 px-1 lh-1" data-i="' +
                        i + '">' +
