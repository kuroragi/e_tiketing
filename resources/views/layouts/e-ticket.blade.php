...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        [data-theme="dark"] .status-dibatalkan {
            background: rgba(100, 116, 139, .2);
            color: #cbd5e1;
        }

        [data-theme="dark"] .status-menunggu_verifikasi {
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        <a class="nav-user-btn dropdown-toggle" href="#" id="navbarDropdown"
                            ...
                            <span
                                class="nav-user-btn user-role-badge d-none d-md-inline">{{ auth()->user()->role ?? 'user' }}</span>
                        </a>
                            ...
                            @if (!auth()->user()->isSkpd())
                                ...
                                @if (auth()->user()->isAdmin() || auth()->user()->isPimpinan() || auth()->user()->isPetugas())
                                    <a class="nav-link {{ request()->routeIs('laporan.index') ? 'active' : '' }}"
                                        href="{{ route('laporan.index') }}" id="sidebar-analitik-link">
    ...
    <footer class="footer">
        <div class="container-fluid px-4">
            <div class="row g-4 mb-3">
                <div class="col-md-4">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <div
                            style="width:32px;height:32px;background:linear-gradient(135deg,#2563eb,#7c3aed);border-radius:8px;display:flex;align-items:center;justify-content:center;">
                    ...
                    <p class="small mb-0" style="color:#64748b;line-height:1.6;">Sistem Ticketing Layanan Dinas
                        Komunikasi dan Informatika Kota Bukittinggi.</p>
                </div>
                <div class="col-md-2">
                    <h6 class="mb-3" style="font-size:.75rem;text-transform:uppercase;letter-spacing:.08em;">
                        Navigasi</h6>
                    <ul class="list-unstyled mb-0">
                        <li class="mb-1"><a href="{{ route('dashboard') }}"
                                class="text-light text-decoration-none small"><i
                                    class="bi bi-house me-1 opacity-50"></i>Dashboard</a></li>
                        <li class="mb-1"><a href="{{ route('panduan') }}"
                                class="text-light text-decoration-none small"><i
                                    class="bi bi-book me-1 opacity-50"></i>Panduan</a></li>
                        <li class="mb-1"><a href="{{ route('tentang') }}"
                                class="text-light text-decoration-none small"><i
                                    class="bi bi-info-circle me-1 opacity-50"></i>Tentang</a></li>
                    </ul>
                </div>
                <div class="col-md-2">
                    <h6 class="mb-3" style="font-size:.75rem;text-transform:uppercase;letter-spacing:.08em;">Bantuan
                    </h6>
                    <ul class="list-unstyled mb-0">
                        <li class="mb-1"><a href="{{ route('hubungi') }}"
                                class="text-light text-decoration-none small"><i
                                    class="bi bi-headset me-1 opacity-50"></i>Hubungi Kami</a></li>
                        <li class="mb-1"><a href="{{ route('kebijakan') }}"
                                class="text-light text-decoration-none small"><i
                                    class="bi bi-shield-check me-1 opacity-50"></i>Kebijakan</a></li>
                        <li class="mb-1"><a href="{{ route('syarat-ketentuan') }}"
                                class="text-light text-decoration-none small"><i
                                    class="bi bi-file-text me-1 opacity-50"></i>Syarat &amp; Ketentuan</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h6 class="mb-3" style="font-size:.75rem;text-transform:uppercase;letter-spacing:.08em;">Kontak
                    </h6>
                    <div class="d-flex align-items-center gap-2 mb-2">
                        <span
                            style="width:28px;height:28px;background:rgba(255,255,255,.08);border-radius:6px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
            ...
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-2">
                <p class="mb-0 small" style="color:#475569;">&copy; {{ date('Y') }} Dinas Komunikasi dan
                    Informatika Kota Bukittinggi.</p>
