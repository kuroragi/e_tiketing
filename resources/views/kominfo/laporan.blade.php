...
@section('content')
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('laporan.index') }}" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-grid">
                <a href="{{ route('laporan.index') }}" class="btn btn-outline-secondary"><i
        ...
        @foreach ($cards as $c)
            <div class="col-6 col-lg-3">
                <div class="report-stat">
                    <div class="mb-2" style="font-size:1.4rem;color:{{ $c['color'] }};"><i
        ...
        <div class="col-lg-4">
            <div class="chart-card h-100">
                ...
                <div class="chart-body d-flex flex-column align-items-center"
                    style="min-height:280px;justify-content:center;">
        ...
        <div class="col-lg-6">
            <div class="chart-card">
                <div class="chart-header">
                    ...
                    <span class="badge bg-secondary rounded-pill" style="font-size:.7rem;">{{ count($skpdReport ?? []) }}
                        SKPD</span>
                </div>
                <div class="p-0">
        ...
        <div class="col-lg-6">
            <div class="chart-card">
                <div class="chart-header">
                    ...
                    <span class="badge bg-secondary rounded-pill" style="font-size:.7rem;">Top
                        {{ count($jenisReport ?? []) }}</span>
                </div>
                <div class="chart-body">
    ...
    @if (!empty($petugasStats) && $petugasStats->isNotEmpty())
        <div class="row g-4 mt-0">
            <div class="col-12">
                <div class="chart-card">
                    <div class="chart-header">
                        <h6 class="mb-0 fw-semibold"><i class="bi bi-person-badge text-primary me-2"></i>Kinerja Petugas
                        </h6>
                        <span class="badge bg-secondary rounded-pill"
                            style="font-size:.7rem;">{{ $petugasStats->count() }} Petugas</span>
                    </div>
