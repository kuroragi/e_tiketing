                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="email@domain.go.id" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Kata Sandi <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="password" name="password" id="addPwd" class="form-control" placeholder="Minimal 8 karakter" required minlength="8">
                                <button class="btn btn-outline-secondary" type="button" onclick="togglePwd('addPwd','addPwdIcon')">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" name="password_confirmation" id="addPwdC" class="form-control" placeholder="Ulangi kata sandi" required minlength="8">
                                <button class="btn btn-outline-secondary" type="button" onclick="togglePwd('addPwdC','addPwdCIcon')">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="editPwd" class="form-control" placeholder="Kosongkan jika tidak diganti" minlength="8">
                                <button class="btn btn-outline-secondary" type="button" onclick="togglePwd('editPwd','editPwdIcon')">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" name="password_confirmation" id="editPwdC" class="form-control" placeholder="Ulangi kata sandi baru" minlength="8">
                                <button class="btn btn-outline-secondary" type="button" onclick="togglePwd('editPwdC','editPwdCIcon')">
