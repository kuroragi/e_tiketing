...
<div class="tab-content">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $ticket['prioritas'] === 'Urgent' ? 'danger' : ($ticket['prioritas'] === 'Tinggi' ? 'warning' : 'success') }}">
                                        {{ $ticket['prioritas'] }}
                                    </span>
                                </td>
                                <td>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info mb-4" role="alert">
                    ...
                    <strong>Cara Kerja:</strong> Sistem akan otomatis menentukan petugas berdasarkan jenis pekerjaan, prioritas, dan keahlian petugas. Konfigurasi di bawah menunjukkan aturan assignment untuk setiap jenis pekerjaan.
                </div>
    ...
    <div class="tab-pane fade" id="manual" role="tabpanel">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted mb-4">Admin dan pihak berwenang dapat memilih petugas secara manual sesuai keputusan.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="alert alert-info" role="alert">
                            <p><i class="bi bi-info-circle me-2"></i><strong>Load Petugas:</strong> Menunjukkan jumlah tiket yang sedang dikerjakan oleh petugas.</p>
                            <p class="mb-0"><i class="bi bi-info-circle me-2"></i><strong>Rekomendasi:</strong> Assign tiket ke petugas dengan load terendah untuk distribusi beban kerja yang lebih merata.</p>
                        </div>
                    </div>
                </div>
            </div>
