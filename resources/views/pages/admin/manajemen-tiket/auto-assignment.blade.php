...
@section('content')
    ...
    <div class="tab-content">
        <!-- Konfigurasi Tab -->
        <div class="tab-pane fade show active" id="config" role="tabpanel" <!-- Info Alert -->
            <div class="alert alert-info border-0 mb-4" role="alert">
                <div class="d-flex">
                    <i class="bi bi-info-circle me-3 display-6"></i>
                    <div>
                        <h5 class="alert-heading">Cara Kerja Auto Assignment</h5>
                        <p class="mb-2">Sistem akan secara otomatis menentukan petugas yang akan menangani tiket
                            berdasarkan:</p>
                        <ul class="mb-0">
                            ...
                            <li><strong>Beban Kerja Petugas:</strong> Distribusi merata berdasarkan jumlah tiket yang sedang
                                dikerjakan</li>
                            ...
                            <div class="mb-4">
                                <div class="border-bottom pb-3 mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable{{ $index }}"
                                            checked>
                                ...
                                @foreach ($rule['rules'] as $ruleIdx => $ruleItem)
                                    <div class="row align-items-end mb-3">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ $ruleItem['kondisi'] }}"
                                                readonly>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control"
                                                    value="{{ $ruleItem['persentase'] }}" min="0" max="100">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            ...
                            <p class="text-muted">Sistem mengidentifikasi petugas yang memiliki keahlian sesuai jenis
                                pekerjaan tiket.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <p class="text-muted">Distribusi tiket secara merata menggunakan persentase yang dikonfigurasi.
                            </p>
                            <div class="bg-light p-3 rounded">
                                <code>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <strong>Catatan:</strong> Beban kerja dihitung berdasarkan jumlah tiket yang sedang dalam status
                        "Berlangsung" dan belum selesai. Sistem auto assignment akan memprioritaskan petugas dengan beban
                        kerja terendah.
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane fade" id="simulation" role="tabpanel">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-4">Simulasikan proses auto assignment untuk menguji konfigurasi Anda sebelum
                        diterapkan ke sistem produksi.</p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary"
                                            onclick="restoreConfig('config_001')">Restore</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary"
                                            onclick="restoreConfig('config_002')">Restore</button>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-outline-primary"
                                            onclick="restoreConfig('config_003')">Restore</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <script>
        ...
        function runSimulation() {
            ...
            const simulationLogic = {
                'PIC Presensi': {
                    'Urgent': {
                        petugas: 'Ahmad Fauzi (A)',
                        reason: '70% probabilitas untuk urgent'
                    },
                    'Tinggi': {
                        petugas: 'Siti Aminah (B)',
                        reason: '60% probabilitas untuk tinggi'
                    },
                    'Sedang': {
                        petugas: 'Ahmad Fauzi (A)',
                        reason: 'Load terendah'
                    },
                    'Rendah': {
                        petugas: 'Budi Santoso (E)',
                        reason: 'Load terendah & tersedia'
                    }
                },
                'Perbaikan Portal': {
                    'Urgent': {
                        petugas: 'Siti Aminah (B)',
                        reason: '60% probabilitas untuk urgent'
                    },
                    'Tinggi': {
                        petugas: 'Rizki Pratama (C)',
                        reason: '70% probabilitas untuk tinggi'
                    },
                    'Sedang': {
                        petugas: 'Rizki Pratama (C)',
                        reason: 'Load terendah'
                    ...
                    'Rendah': {
                        petugas: 'Rizki Pratama (C)',
                        reason: 'Sesuai keahlian'
                    }
                },
                'Troubleshooting': {
                    'Urgent': {
                        petugas: 'Rizki Pratama (C)',
                        reason: '50% probabilitas untuk urgent'
                    },
                    'Tinggi': {
                        petugas: 'Desi Marlina (D)',
                        reason: 'Load seimbang'
                    },
                    'Sedang': {
                        petugas: 'Ahmad Fauzi (A)',
                        reason: 'Load terendah'
                ...
                'Maintenance Server': {
                    ...
                    'Sedang': {
                        petugas: 'Budi Santoso (E)',
                        reason: 'Expert di bidang ini'
                    },
                    'Rendah': {
                        petugas: 'Budi Santoso (E)',
                        reason: 'Satu-satunya yang terlatih'
                    }
                }
            };
            ...
            document.getElementById('simulationResult').scrollIntoView({
                behavior: 'smooth'
            });
