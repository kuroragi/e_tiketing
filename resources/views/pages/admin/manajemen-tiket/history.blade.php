                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress">
                                <div class="progress-bar bg-success"
                                    style="width: {{ ($petugas['otomatis'] / $petugas['total']) * 100 }}%;"
                                    title="Otomatis: {{ $petugas['otomatis'] }}"></div>
                                <div class="progress-bar bg-warning"
                                    style="width: {{ ($petugas['manual'] / $petugas['total']) * 100 }}%;"
                                    title="Manual: {{ $petugas['manual'] }}"></div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <p class="small">Perbaikan pada bagian login portal kominfo yang mengalami masalah autentikasi.
                            Sudah dilakukan pengecekan dan perbaikan pada database dan konfigurasi server.</p>
                    </div>
                </div>
            </div>
        </div>
